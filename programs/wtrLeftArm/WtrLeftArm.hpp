...
#ifndef __FM_WAITER_LEFT_ARM_HPP__
#define __FM_WAITER_LEFT_ARM_HPP__
 ...
 * @ingroup WtrLeftArm
 *
 * @brief Waiter Left Arm.
 *
 */
class WtrLeftArm : public RFModule {
    public:
...
#endif  // __FM_WAITER_LEFT_ARM_HPP__
